...
#' Get GEO data
#'
#' @param gse A character vector of the GEO series IDs
#' @param ... Other arguments passed to getGEO
#'
#' @return NULL
#'
#' @examples
...
#'
#' @export
expression_get <- function(gse, ...) {
  # downlaod gse matrices and metadata
  map(gse, function(x) getGEO(x, ...))
}
